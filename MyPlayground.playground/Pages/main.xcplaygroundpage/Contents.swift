...
func countriesOfContinent(continent:String, numberOfCountries:Int){
    print("\(continent) is a continent which contains \(numberOfCountries) countries.")
}


countriesOfContinent(continent: "Asia", numberOfCountries: 100)
/*: question2
 ...
 */
// write your code here
func bottlesOfBeverage(numberOfBottles:Int, beverage:String, place:String){
    print("\(numberOfBottles) bottles of \(beverage) on the \(place)")
}


bottlesOfBeverage(numberOfBottles: 2, beverage: "coke", place: "frigde")
